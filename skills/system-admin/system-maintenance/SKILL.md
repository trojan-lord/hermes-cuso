...
- Project directories (`~/marshall-voice/`, `~/qwentts.cpp/`, `~/demucs-env/`) should NOT be moved — they are working directories with active references in scripts and config.
